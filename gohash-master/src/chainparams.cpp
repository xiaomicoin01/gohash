...
public:
    CMainParams() {
        ...
        vout.resize(1);
        vout[0].SetEmpty();
        CTransaction txNew(1, 1514944745, vin, vout, 0);
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime    = 1514944745;
...
#endif
        assert(hashGenesisBlock == uint256("0x15ff2a4e23d9bfd4074511d06d7d2aef65dd01b2da465b13a5a492446ef0b72b"));
        assert(genesis.hashMerkleRoot == uint256("0xfb07dc2dabf5c32a09cfe98c3fee2fd262a807a58a81aec98932b0ba7c4bd447"));
        ...
        vSeeds.push_back(CDNSSeedData("101.132.76.233","101.132.76.233"));
        vSeeds.push_back(CDNSSeedData("39.106.220.117","39.106.220.117"));
        convertSeeds(vFixedSeeds, pnSeed, ARRAYLEN(pnSeed), nDefaultPort);

        nPoolMaxTransactions = 3;

        strDarksendPoolDummyAddress = "GV1BESiHBX1oDUG5J3SqzcTWosWqiuBGhw";
