...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    //101 - 500 Block - 1 NMS per Block
    //501 - 10 000 Block - 8 NMS per Block
    //10 001 - 30 000 Block - 7 NMS per Block
    //30 001 - 60 000 Block - 6 NMS per Block
    //60 001 - 80 000 Block - 5 NMS per Block
    //80 001 - 120 000 Block - 2 NMS per Block
    ...
    if (nHeight <= 0) {
        ...
        nSubsidy = 42000 * COIN; // premine to be confirmed
    }
    else if (nHeight <= 500) {
...
int64_t GetProofOfStakeReward(const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees)
{
    ...
    //501 - 10 000 Block - 8 NMS per Block
    //10 001 - 30 000 Block - 9 NMS per Block
    //30 001 - 60 000 Block - 10 NMS per Block
    //60 001 - 80 000 Block - 11 NMS per Block
    //80 001 - 120 000 Block - 12 NMS per Block
    //120 001- 240 000 Block ¨C 10 NMS per Block
   // After 240 001 - 8 NMS per Block
    ...
    if (heigth <= 500) {
        ...
        nSubsidy = 8 * COIN;
    }else if (heigth <= 30000)  {
        nSubsidy = 9 * COIN;
    }else if (heigth <= 60000)  {
        nSubsidy = 10 * COIN;
    }else if (heigth <= 80000)  {
        nSubsidy = 11 * COIN;
    }else if (heigth <= 120000)  {
        nSubsidy = 12 * COIN;
    }else if (heigth <= 240000)  {
        nSubsidy = 10 * COIN;
    }else{
        nSubsidy = 8 * COIN;
    }
